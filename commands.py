...
def gamestart(bezar, enemies, items, inventory, save, ablak):
    ...
    #elfelejtettem ez a gomb mit akarˇ
    valami = tkinter.Button(ablak, height=5, width=10, background='#ffffff', text="valamikep")#, command=valamibutton)
    trash = tkinter.Button(ablak, height=3, width=8, background='#ffffff', text="trashkep")#, command=trashbutton) 
    wavecounter = tkinter.Button(ablak, height=6, width=15, background='#ffffff', text="wavecounter")#, command=wavecounter)
    ...
    gamecanvas.create_window(54, 560, window=valami)

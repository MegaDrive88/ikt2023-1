...
startgomb = tkinter.Button(height = 1, width= 14, text='Start game', font = ('Fette UNZ Fraktur', 20), relief='ridge' , background='#fcba03', foreground='#850505', command = gamestart)
helpgomb = tkinter.Button(height = 1, width= 14, text='Help', font = ('Fette UNZ Fraktur', 20), relief='ridge' , background='#fcba03', foreground='#850505', command = segitseg)
exitgomb = tkinter.Button(height = 1, width= 14, text='Exit', font = ('Fette UNZ Fraktur', 20), relief='ridge' , background='#fcba03', foreground='#850505')# command = u sure?
